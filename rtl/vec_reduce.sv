...
#(
  ...
  always_comb begin
    for (int e = 0; e < MaxElems; e++) begin
      ...
      case (vsew)
        ...
        3'd1: raw = (e < MaxElems / 2) ? 32'(vs2_data[16*e+:16]) : 32'd0;
        default: raw = (e < MaxElems / 4) ? vs2_data[32*e+:32] : 32'd0;
      endcase
  ...
  assign result = DLEN'(acc_next & (32'hFFFF_FFFF >> (6'd32 - acc_bits)));
